...
pictureToCW (ThickCircle t r) = CW.thickCircle (coordToCW r) (coordToCW t) -- swapped arguments
pictureToCW (Arc th1 th2 r) = CW.arc (angleToCW th1) (angleToCW th2) (coordToCW r)
pictureToCW (ThickArc th1 th2 r t) = CW.thickArc (coordToCW t) (angleToCW th1) (angleToCW th2) (coordToCW r)
